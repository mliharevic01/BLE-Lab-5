// ======================================================================
// Project5.v generated from TopDesign.cysch
// 12/06/2016 at 16:49
...
module SCB_P4_v2_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("0080c25e-865b-4f9e-a664-f6e77084f05f/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0080c25e-865b-4f9e-a664-f6e77084f05f/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
